            ...
            <Container fluid className='main-container'>
                ...
                <Container fluid className="section-container">
                    <h3 style={{textAlign:"center"}}> We are a preffered vendor for multiple national corporations.</h3>
                        ...
                        <img src='/assets/ge_healthcare.webp' alt="" className="vendor-pic"></img>
                        <img src='/assets/fujifilm.webp' alt="" className="vendor-pic"></img>
                        </Container>
                </Container>

                <Container className="bottom-pic-container">
                    <img src='/imgs/interior_ventilation.webp' alt="" className="home-pic"></img>
                    <img src='/imgs/hotel_lobby.webp' alt="" className="home-pic"></img>
                    <img src='/imgs/mri1.webp' alt="" className="home-pic"></img>
                    <img src='/imgs/cement_pour.webp' alt="" className="home-pic"></img>
